...
const HomePage = () => {
  ...
  return (
    <div className="bg-dark text-white overflow-hidden">
      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-transparent position-absolute w-100 z-3 py-3">
        <div className="container">
          ...
          >
            ...
            Photo
            <span className="text-warning" style={{ textShadow: "0 0 10px rgba(255, 193, 7, 0.5)" }}>
              Market
            </span>
          </Link>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto align-items-lg-center gap-2 gap-lg-3 py-3 py-lg-0">
              <li className="nav-item">
                <Link className="nav-link px-3 text-white" to="/explore">
                  Explore
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link px-3 text-white" to="/pricing">
                  Pricing
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link px-3 text-white" to="/become-seller">
                  Become a Seller
                </Link>
              </li>
              <li className="nav-item mt-2 mt-lg-0">
                <Link to="/login">
                  <button className="btn btn-outline-light rounded-pill px-4 w-100 w-lg-auto">
              ...
              <li className="nav-item mt-2 mt-lg-0">
                <Link to="/register">
                  <button className="btn btn-warning rounded-pill px-4 text-dark fw-semibold w-100 w-lg-auto">
              ...
              {loading ? (
                <div className="placeholder-glow px-3">
                  <SkeletonBox
                    width="150px"
                    height="30px"
                    className="mb-3 rounded-pill mx-auto mx-lg-0"
                  />
                  ...
                  <div className="d-flex flex-column flex-sm-row gap-3 justify-content-center justify-content-lg-start mb-5">
                    <SkeletonBox
                      width="160px"
                      height="48px"
                      className="rounded-pill mx-auto mx-sm-0"
                    />
                    <SkeletonBox
                      width="160px"
                      height="48px"
                ...
                <>
                  <div className="badge bg-warning text-dark px-3 py-2 rounded-pill mb-3">
                    ...
                    <span className="d-none d-sm-inline">Trusted by 10,000+ Creators</span>
                  ...
                  <div className="d-flex flex-column flex-sm-row gap-3 justify-content-center justify-content-lg-start mb-5">
                    <Link to="/explore" className="text-decoration-none">
                      <button className="btn btn-warning rounded-pill px-4 py-2 fw-bold text-dark w-100">
                        <i className="fas fa-search me-2"></i>
                        Start Exploring
                      </button>
                    </Link>
                    <Link to="/demo" className="text-decoration-none">
                      <button className="btn btn-outline-light rounded-pill px-4 py-2 w-100">
      ...
      {/* Featured Photos - Responsive Grid */}
      <section className="py-5 bg-black">
        <div className="container">
          <div className="text-center mb-4">
            ...
            <p className="text-white-50 small mx-auto px-3" style={{ maxWidth: "500px" }}>
                    ...
                    <div className="card bg-transparent border-0 h-100">
                      <div className="position-relative overflow-hidden rounded-3">
                        ...
                        <div className="position-absolute bottom-0 start-0 end-0 p-2 bg-dark bg-opacity-75">
                          <h6 className="text-white mb-0 small fw-bold text-truncate">
                            {photo.title}
                          </h6>
            ...
            {categories.map((cat, idx) => (
              <div key={idx} className="col-4 col-md-2">
                <Link to={`/explore?category=${cat.name.toLowerCase()}`} className="text-decoration-none">
                  <div
                    className="card bg-dark border-secondary text-center p-3 h-100"
                    style={{
                  ...
                  >
                    <div className="card-body p-1 p-md-2">
                      <i className={`${cat.icon} text-warning mb-2`} style={{ fontSize: "1.5rem" }}></i>
                      <h6 className="fw-bold mb-1 small">{cat.name}</h6>
                      <small className="text-white-50">
                        {cat.count} photos
                      </small>
                    </div>
        ...
        <div className="container">
          ...
          <div className="row g-3">
            {testimonials.map((testimonial, idx) => (
              <div key={idx} className="col-12 col-md-4">
                <div
                  className="card bg-dark border-secondary h-100 p-4"
                  style={{
                    background: "rgba(255, 255, 255, 0.03)",
                    border: "1px solid rgba(255, 255, 255, 0.1)",
                  }}
        ...
        <div className="container text-center">
          ...
          <div className="d-flex flex-column flex-sm-row gap-2 justify-content-center">
            ...
            <Link to="/contact" className="text-decoration-none">
              <button className="btn btn-outline-dark rounded-pill px-4 py-2 w-100">
          ...
          <div className="row g-4">
            ...
            <div className="col-6 col-md-2">
              ...
              <ul className="list-unstyled">
                ...
                <li className="mb-2">
                  <Link to="/careers" className="text-white-50 text-decoration-none">
                    Careers
                  </Link>
                </li>
                <li className="mb-2">
                  <Link to="/press" className="text-white-50 text-decoration-none">
                    Press
                  </Link>
                </li>
              </ul>
            ...
            <div className="col-6 col-md-2">
              ...
              <ul className="list-unstyled">
                ...
                <li className="mb-2">
                  <Link to="/sell" className="text-white-50 text-decoration-none">
                    Sell
                  </Link>
                </li>
                <li className="mb-2">
                  <Link to="/api" className="text-white-50 text-decoration-none">
                    API
                  </Link>
                </li>
              </ul>
            ...
            <div className="col-12 col-md-4">
              <h6 className="text-white fw-bold mb-3">Subscribe</h6>
