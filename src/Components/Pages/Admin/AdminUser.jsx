...
const API = "https://pm-backend-1-0s8f.onrender.com/api/auth";
...
const AdminUsers = () => {
  ...
  const handleEditUser = async (e) => {
    ...
    // Validate form for edit (password optional)
    ...
    try {
      ...
      await axios.put(`${API}/users/${editingUser._id}`, updateData, { headers });
      fetchUsers();
  ...
  return (
    <AdminLayout>
      ...
      <div className="position-relative" style={{ zIndex: 1 }}>
        ...
        <div 
          className="row g-3 mb-4 p-3 rounded-4"
          style={glassStyle}
        >
