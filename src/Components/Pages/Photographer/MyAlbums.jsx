    ...
    >
      ...
      <div style={{ padding: "1rem" }}>
        ...
        <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
          ...
          {album.isPrivate ? (
            <button onClick={copyShareLink} style={{ flex: 1, padding: "0.5rem 0", background: copied ? "#4CC9A6" : "var(--pm-teal-pale, #EEF8FB)", color: copied ? "#fff" : "var(--pm-teal, #6BBDD0)", border: "none", borderRadius: 9, fontWeight: 600, fontSize: "0.82rem", cursor: "pointer" }}>
              <i className={`fas ${copied ? "fa-check" : "fa-link"} me-1`}></i>{copied ? "Copied!" : "Copy Link"}
            </button>
          ) : (
            <Link to={`/album/${album._id}`} target="_blank" style={{ flex: 1, padding: "0.5rem 0", background: "var(--pm-teal-pale, #EEF8FB)", color: "var(--pm-teal, #6BBDD0)", borderRadius: 9, fontWeight: 600, fontSize: "0.82rem", textAlign: "center", textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.35rem" }}>
